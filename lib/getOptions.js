...
var getBaseOptions = function(cb){
  ...
  if(process.env.TF_BUILD){
    ...
    git_branch = process.env.BUILD_SOURCEBRANCH;
  }

  if (process.env.COVERALLS_GIT_COMMIT !== undefined) {
    git_commit = process.env.COVERALLS_GIT_COMMIT;
  }

  if (process.env.COVERALLS_GIT_BRANCH !== undefined) {
    git_branch = process.env.COVERALLS_GIT_BRANCH;
  }
